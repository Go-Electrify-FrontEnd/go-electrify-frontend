...
export const connectorTypeBaseSchema = z.object({
  name: z.string().trim().min(1, "Tên cổng kết nối là bắt buộc"),
  description: descriptionField,
  maxPowerKw: maxPowerField,
});

export const connectorTypeCreateSchema = connectorTypeBaseSchema;

export const connectorTypeUpdateSchema = connectorTypeBaseSchema.extend({
