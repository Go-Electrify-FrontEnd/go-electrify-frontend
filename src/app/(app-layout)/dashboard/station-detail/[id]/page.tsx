...
// === THÊM FORM MỚI ===
import StationStaffAssignForm from "@/features/stations/components/station-staff-assign-form";
  ...
  return (
    <div className="flex flex-col gap-6 md:gap-6">
      ...
      <SectionContent>
        ...
        {/* BẢNG NHÂN VIÊN - CHỈ HIỆN CHO ADMIN */}
  ...
  return (
    <Card>
      <CardHeader>
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          ...
          <CardAction>
            <div className="flex items-center gap-2">
              {/* DÙNG FORM MỚI */}
              <StationStaffAssignForm stationId={stationId} />
            </div>
          </CardAction>
        </div>
      </CardHeader>
      <CardContent className="p-0">
        <div className="p-3 sm:p-6">
          <SharedDataTable
            columns={stationStaffColumns(stationId)}
            data={staff}
