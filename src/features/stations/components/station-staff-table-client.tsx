...
export function StationStaffTableClient({
  ...
  const columns = createStationStaffColumns(stationId);
  ...
  const searchColumn = table.getColumn("userEmail");
                ...
                <TableCell colSpan={columns.length} className="p-8">
                  <Empty className="border-muted-foreground/30 bg-muted/40 border border-dashed p-8">
                    <EmptyHeader>
                      ...
                      <EmptyDescription>
                        Chưa có nhân viên nào được phân công cho trạm này. Nhấn nút phía trên để thêm nhân viên.
                      </EmptyDescription>
                    </EmptyHeader>
                  </Empty>
                </TableCell>
